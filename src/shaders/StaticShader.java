...
public class StaticShader extends ShaderProgram {
    ...
    private int location_fakeLightning;
    ...
    protected void getAllUniformLocations() {
        ...
        location_fakeLightning = super.getUniformLocation("fakeLightning");
    ...
    public void loadLights(List<Light> lights) {
        for (int i = 0; i < MAX_LIGHTS; i++) {
            if (i < lights.size()) {
                super.loadVector(location_lightPosition[i], lights.get(i).getPostion());
    ...
    public void loadFakeLightningVariable(boolean fake) {
        super.loadBoolean(location_fakeLightning, fake);
    }
